        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((testimonial) => (
              <Card key={testimonial.name} className="flex flex-col border-transparent bg-background/50 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10">
