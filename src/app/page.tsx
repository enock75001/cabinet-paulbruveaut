...
const services = [
  ...
  },
  {
    ...
    description: "Création de sociétés, fusions, acquisitions.",
  },
];
    ...
    <div>
      <section className="relative bg-background py-24 sm:py-32 md:py-40">
        <div className="container mx-auto px-4 text-center">
          <p className="font-semibold text-primary">Cabinet Notarial Bruveau</p>
          <h1 className="font-headline text-4xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-6xl mt-2">
      ...
      <section id="services" className="py-20 sm:py-24 bg-secondary/50">
      ...
      <section id="testimonials" className="py-20 sm:py-24 bg-secondary/50">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
